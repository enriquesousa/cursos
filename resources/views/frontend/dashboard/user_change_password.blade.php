...
{{-- Cambiar Contraseña, oldpassword, newpassword, confirmnewpassword | Botón de Cambiar Contraseña | Recuperar Contraseña  --}}
<div class="setting-body">
    ...
    <form method="post" class="row" action="{{ route('user.password.update') }}">
        ...
        <div class="input-box col-lg-4">
            <label class="label-text">Confirmar Nueva Contraseña</label>
            <div class="form-group">
                <input class="form-control form--control" type="password" name="new_password_confirmation" id="new_password_confirmation" placeholder="Confirme nueva contraseña">
                <span class="la la-lock input-icon"></span>
            </div>
        </div><!-- end input-box -->
        ...
        <div class="input-box col-lg-12 py-2">
            <button class="btn theme-btn">Cambiar Contraseña</button>
        </div><!-- end input-box -->
    ...
    <form method="post" class="pt-5 mt-5 border-top border-top-gray">
        <h3 class="fs-17 font-weight-semi-bold pb-1">Olvide Mi Contraseña</h3>
        <p class="pb-4">Ingrese el correo electrónico de su cuenta para restablecer la contraseña. Luego recibirás un enlace al correo electrónico.
            para restablecer la contraseña. Si tiene algún problema con el restablecimiento de contraseña
            <a href="contact.html" class="text-color">Contáctenos</a></p>
        <div class="input-box">
        ...
        <div class="input-box py-2">
            <button class="btn theme-btn">Recuperar Contraseña</button>
        </div><!-- end input-box -->
    </form>
