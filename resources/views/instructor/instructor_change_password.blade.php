...
@section('instructor')
    ...
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Instructor - Cambiar Contraseña</div>
            <div class="ps-3">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="card">
                            ...
                            <form action="{{ route('update.instructor.password') }}" method="POST"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                            <h6 class="mb-0">Contraseña Actual</h6>
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                            <h6 class="mb-0">Contraseña Nueva</h6>
                                        </div>
                                        <div class="col-sm-9 text-secondary">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                            <h6 class="mb-0">Confirmar Contraseña</h6>
                                        </div>
                                        <div class="col-sm-9 text-secondary">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="submit" class="btn btn-primary px-4" value="Actualizar Contraseña" />
                                        </div>
                                    </div>
